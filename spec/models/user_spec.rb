...
describe User do
  before do
    @user = User.new(name: "binbean", email: "binbean@example.com",
  ...
  describe "when email adresss is already taken" do
    before do
  ...
  describe "when password doesn't match comfirmation" do
